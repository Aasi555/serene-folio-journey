...
const HeroSection = () => {
  const handleDownloadResume = () => {
    ...
    link.href = "/Software_Engineer_5.3yrs.pdf"; // No process.env
      ...
      <div className='max-w-4xl mx-auto text-center'>
        <div className='space-y-8'>
          ...
          <p className='text-lg md:text-xl text-foreground/80 max-w-2xl mx-auto leading-relaxed'>
            ...
            development, cloud technologies, and a growing interest in product
            management. Currently expanding my skills in cloud development while
