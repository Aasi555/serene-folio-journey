...
const timelineSteps = [
  {
    ...
    description: "Completed Bachelor's in Computer Science Engineering",
    status: "completed",
    icon: "🎓"
  },
  {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            My professional journey from engineering graduate to aspiring product manager
          </p>
        </div>
            ...
            {timelineSteps.map((step, index) => (
              ...
              >
                ...
                <div className={`w-full md:w-5/12 ml-16 md:ml-0 ${index % 2 === 0 ? 'md:mr-auto md:pr-8' : 'md:ml-auto md:pl-8'}`}>
                  <Card className={`
                    ${step.status === 'current' ? 'bg-primary/10 border-primary shadow-glow' : 'bg-card'}
